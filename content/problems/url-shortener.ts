...
export const URL_SHORTENER: Problem = {
  ...
  slack: {
    ...
    body: [
      ...
      'The write path has plenty of slack, and almost nobody uses it. Creating a link is a thing a person does once, deliberately, and waiting 300 ms for it is completely fine. So you can afford a database round trip, a uniqueness check, even a retry, on writes — and you must afford none of that on reads.',
  ...
  stages: [
    {
      ...
      model: [
        ...
        'Scope I propose: create a link, optionally with a custom code; follow a link; and rough click counts. Out of scope: editing links, expiry, link previews, spam and malware checking — I would flag that last one as a real production requirement I am deliberately setting aside.',
      ],
      checklist: [
        ...
        'Named at least one thing deliberately out of scope',
      ],
      tradeoffs: [
        {
...

    {
      ...
      checklist: [
        ...
        'Made the 301 vs 302 decision deliberately',
      ],
      tradeoffs: [
        {
