...
export const NEARBY_PLACES: Problem = {
  ...
  slack: {
    ...
    body: [
      ...
      'The other genuinely dynamic case is live availability — a table free tonight, a bike at a dock. If that is in scope it is a separate fast path, not a reason to make the place index live.',
    ],
    consequence:
  ...
  stages: [
...

    {
      ...
      model: [
        ...
        'Deduplication, revisited as an ongoing system rather than a one-off: matching places across providers by name similarity, proximity and category, with a confidence threshold, and merging below it. Two failure directions: merging two genuinely different shops in the same building, and failing to merge one shop listed twice. The second is more visible to users, so I would tune toward merging and provide an unmerge path. Cost: some false merges, which need a correction mechanism and a human in the loop.',
      ...
      tradeoffs: [
        ...
        },
        {
          ...
          cost: 'Occasionally merges two genuinely different businesses. Chosen because a visible duplicate is the more common and more noticeable failure.',
        },
        {
