  ...
  stages: [
    {
      ...
      model: [
        ...
        'Scope I propose: syncing a folder across a user\'s devices, sharing with other users, offline edits with conflict detection, resumable upload and download of large files, and version history. Out of scope: real-time collaborative editing inside a document, which is a genuinely different system built on operational transforms or CRDTs rather than on file sync.',
      ],
      checklist: [
      ...
      tradeoffs: [
        {
          ...
          cost: 'All changes in an account serialise through one counter, so a shared folder with very heavy write activity has a ceiling. In exchange, sync becomes trivially correct and resumable.',
        },
        {
...

    {
      ...
      checklist: [
        ...
        'Chunk garbage collection by reference, deliberately conservative',
