  ...
  sections: [
    {
      ...
      points: [
        ...
        'Using a log for simple background jobs is over-building. A work queue is really simpler to operate.',
      ],
      callouts: [
        {
          variant: 'say-this',
    ...
    },
    {
      ...
      points: [
        ...
        'If you really need global order, you need a single partition, which means a single consumer and a hard throughput ceiling. Say that ceiling out loud.',
      ],
      visuals: [
        {
          type: 'diagram',
    ...
    },
    {
      ...
      points: [
        ...
        '**Shed low-value work on purpose**: drop the digest emails and keep the password resets. This requires having separated them, which is why priority queues exist.',
