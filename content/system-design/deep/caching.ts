  ...
  sections: [
    {
      ...
      points: [
        ...
        'The browser is the only layer you really cannot invalidate, which is why versioned filenames exist.',
      ],
      callouts: [
        {
          variant: 'say-this',
    ...
    },
    {
      ...
      points: [
        ...
        '**Write-behind**: write the cache now, the database shortly after. Fast writes, and you can lose data in the gap. Only acceptable when the data is really disposable.',
      ],
      compare: {
        ...
        verdict:
          'Cache-aside for almost everything, because degrading rather than breaking is worth more than avoiding invalidation. Write-through only where the read-after-write pattern is guaranteed and staleness is really unacceptable.',
      },
      callouts: [
        {
          variant: 'trap',
