...
export const NOTIFICATION_SYSTEM: Problem = {
  ...
  stages: [
...

    {
      ...
      model: [
        'Assume 50 million users receiving about 5 notifications a day. That is 250 million a day, divided by 100,000 seconds, so roughly 2,500 per second on average. Really small.',
...

    {
      ...
      tradeoffs: [
        ...
        },
        {
          ...
          cost: 'A second contract, second integration and two sets of delivery reports to reconcile. Only worth it on channels where an outage is really costly.',
        },
      ],
      sayThis:
