...
export const TYPEAHEAD: Problem = {
  ...
  compare: {
    ...
    verdict:
      'Precompute. You have hours of freshness slack and 100 ms of serving budget — that is the textbook signal to move work from read time to build time. Add a small trending layer for the one case where hours is really too slow, rather than making everything real-time to serve a fraction of the terms.',
  },
