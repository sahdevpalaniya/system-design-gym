  ...
  sections: [
...

    {
      ...
      body: [
        ...
        '**Denormalisation** deliberately stores a fact more than once to avoid the join. Copy the customer name onto the order row so displaying an order needs one read instead of two.',
    ...
    {
      heading: 'NoSQL, type by type — and what each is genuinely for',
      body: [
...

    {
      ...
      body: [
        'ACID describes what relational databases promise. BASE describes what many distributed stores offer instead, and it is deliberately weaker.',
...
export const SQL_NOSQL_EXAMPLE: WorkedExample = {
  ...
  steps: [
    ...
    },
    {
      ...
      detail:
        'Every read is a lookup by a single key. That is genuinely key-value shaped, which is why people reach for a key-value store here — and the read path does use one, as a cache. The question is what holds the durable truth.',
    },
    {
      step: 'Decide',
      detail:
