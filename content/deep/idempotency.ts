  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        ...
        'Too broad and it blocks legitimate repeats. Hashing just the user id and amount means a customer who genuinely buys the same coffee twice gets refused the second time.',
    ...
    },
    {
      ...
      body: [
        'The cheapest idempotency is the kind you get from the shape of the operation, with no key store, no retention policy and nothing for anyone to forget. Reach for this first, and only fall back to keys when the work genuinely cannot be reshaped.',
      ],
      points: [
