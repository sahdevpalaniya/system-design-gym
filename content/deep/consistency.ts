  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        'Strong consistency means a write is not confirmed until a majority agrees, and often that a read consults a majority too. That is a round trip added to every operation, permanently. Inside one datacenter it is about half a millisecond and genuinely cheap. Across regions it is 80 milliseconds or more, and it applies on every good day, not just during failures.',
      ],
      visuals: [
        {
          type: 'numbers',
      ...
      points: [
        'Strong consistency also means unavailability on the minority side of a network split. That is a deliberate choice, and for seats or balances it is the right one.',
    ...
    },
    {
      ...
      callouts: [
        {
          variant: 'trap',
          text: 'The last one is a genuine trap rather than pedantry. Being able to say "those are two different words that happen to share a letter" is a small, reliable senior signal.',
        },
      ],
    },
  ],
