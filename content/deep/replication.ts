...
export const REPLICATION_DEEP: DeepDive = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        'Failover is not a switch. It is a sequence, and every step in it has a cost that shows up as downtime or as lost data. Being able to narrate it is what separates someone who has run a database from someone who has read about one.',
