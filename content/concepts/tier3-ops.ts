...
export const TIER3_OPS: Concept[] = [
      ...
      compare: {
        ...
        b: {
          ...
          points: [
            ...
            'Mitigated by caching, which quietly reintroduces the revocation delay.',
...

  {
    ...
    body: [
      ...
      '**Feature flags** separate deploying from releasing, which is genuinely powerful: the code ships dark, is enabled for staff, then a percentage, then everyone, and switching it off does not need a deploy. Two disciplines keep them from becoming the problem. Flags need an owner and a removal date, or you accumulate hundreds and no combination is tested. And a flag that changes data shape is not a safe flag — turning it off later leaves rows written in the new shape.',
      ...
      compare: {
        ...
        a: {
          ...
          points: [
            ...
            'Simple to reason about, easy to test, trivially re-runnable when logic changes.',
